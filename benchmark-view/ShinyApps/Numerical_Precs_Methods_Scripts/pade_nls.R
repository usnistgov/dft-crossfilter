...
y<-mydata$P                 # Select the ground state energy E0
...
# 2nd order Pade
m<-nlsLM(y~(a1*x+a2*x^2)/(b0+b1*x+x^2), start = list(a1 = coef(m)[1], a2 = coef(m)[1], b0 = coef(m)[2], b1 = 1.0), subset = l1:l-l2, weights = x^2)
m2=m
