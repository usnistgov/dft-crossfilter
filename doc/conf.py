...
html_theme_options = {
    'navbar_title': "*",
    'navbar_links': [
        ("setup", "rst/SETUP.html", True),
        ("use", "rst/APP_USAGE.html", True),
        ("contribute", "https://github.com/usnistgov/dft-crossfilter", True),
        ("NIST", "https://www.nist.gov/programs-projects/dft-benchmarking", True),
    ],
...
html_title = "DFT Crossfilter"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "DFT Crossfilter"
...
latex_documents = [
    ('index', 'dft.tex', u'DFT Crossfilter Documentation',
...
man_pages = [
    ('index', 'dft', u'DFT Crossfilter Documentation',
...
texinfo_documents = [
    ('index', 'dft', u'DFT Crossfilter Documentation',
     u'Faical Yannick P. Congo', 'dft', 'Density Functional Theory',
     'Miscellaneous'),
]
